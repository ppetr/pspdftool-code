...
Hlavièka konèí komentáøem {\it \%\%EndComments},
...
Po ní následují jednotlivé stránky.
 ...
 Zaèátek stránky, oznaèuje komentáø {\it \%\%Page: jméno\_stránky  její\_èíslo}. Pøi tisku by nemìly být stránky závislé na poøadí, v~jakém jsou uvedeny v~souboru.
...
\begin{tabular}{lp{8 cm}}
	...
	&\\
	{\tt pspdftool "foo" in.pdf out.pdf}  & naète soubor in.pdf aplikuje na seznam stránek pøíkaz foo a výsledek ulo¾í do souboru out.pdf (uvozovky kolem pøíkazu jsou kvùli shellu)\\
...
Vezmeme seznam  stránek '1 2 3 4 5' a aplikujeme na nìj modulo s n rovným 3. Nejprve se seznam doplní na vhodnou délku '1 2 3 4 5 6' 
a rozdìlí se na pøílslu¹né skupinky '1 2 3' a '4 5 6'. Vybereme \{1 -1\} '1 6' a '4 3' a výsledek spojíme '1 6 4 3'.
Pokud parametr half je roven 1, zpracovává se pouze polovina skupinek. V~tom pøípadì je výsledek pøedchozího pøíkladu '1 6'.
