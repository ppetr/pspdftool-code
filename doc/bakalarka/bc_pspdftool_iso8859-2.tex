...
mít nainstalované konkrétní øezy písma. Tato závislost mù¾e zpùsobit rozdílné výsledky tisku na rùzných poèítaèich pøi pou¾ití jiného fontu.
...
Pøedtiskové úpravy se týkají formátù explicitnì urèených pro tisk, patøí mezi nì pøeskupení, otoèení, selekce, zmìna formátu papíru, zvìt¹ení èi zmen¹ení stránek,
ale netýkají se: zmìny  obsahu, formátu, stylu odstavce nebo jiný zásah do struktury stránky.
...
Nìkteré ovladaèe tiskáren umo¾òují provést nìkteré z~tìchto operací, ale obecnì se jedná o~proprietární roz¹íøení konkrétního dodavatele ovladaèe.
...
Mezi základní elementy jazyka PostScript  patøí: oblouk, B\`ezeriova køivka a úseèka. Pro písmo existují speciální pøíkazy, které vykreslí písmena z~køivek. Tyto elementy nejsou zavislé na rozli¹ení výstupního zaøizení.
...
Defaults section je nepovinná èást PS dokumentu, která  je slo¾ena pouze DSC komentáøù. Obsahuje doplòující informace o~dokumentu, 
...
Po ní následují jednotlivé stránky.
 ...
 generujících PostScript, ho dìlení nepou¾ívá.
...
Vzhledem k~tomu, ¾e nìkteré èásti PDF kmohou být omprimovány, je také vhodný pro pøenos dokumentù pøes sí» Internet.
...
druhé urèuje jeho reverzi, novìj¹í verze objektu má vy¹¹í èíslo.
...
Stream pro popis obsahu stránky nebo XObjectu je syntakticky podobný jazyku PostScript, tj. prefixovou notací, pouze operátory  mají jiné názvy a nelze je pøedefinovat, a také není závislý na rozli¹ení cílového zobrazovacího zaøízení.
...
{\tt bbox norm(center=y) scale(a4)} & pøepoèítání okrajù a pøizpùsobení velikosti stránek na papír a4,
...
Pro tento pøípad jsem implementoval formát {\it dummydoc}, jeho¾ interface je zavolán v~pøípadì absence urèité funkce konkrétního formátu. Ve vìt¹inì pøípadech skonèí toto volání chybou.
