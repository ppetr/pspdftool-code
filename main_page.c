/*! \mainpage PSPDFTool
  ...
  Prepnete se do adresare src. (cd pspdftool/src).
  Napiste make && make install
  \section using_sec Ovladani
  Navod pro obsluhu nastroje obdrzite spusteni toolu bez parametru (pspdftool),
  nebo z manualovych stranek nastroje (man pspdftool).
 */ 
